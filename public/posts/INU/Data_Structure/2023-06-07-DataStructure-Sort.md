---
title: "[Data Structure] 정렬(Sort)(1) - 선택 정렬(Selection Sort) / 삽입 정렬(Insertion Sort) / 버블 정렬(Bubble Sort)"
date: 23. 06. 07
categories:
  - DataStructure
...
<img src="/assets/images/INU/datastructure/Sort.png" alt="Sort_Procdess">
...
<img src="/assets/images/INU/datastructure/Sort_record.png" alt="Sort_record_Procdess"><br>`레코드(record)와 필드의 형태.`<br><br>
...
<img src="/assets/images/INU/datastructure/in_ex_sorting.png" alt="in_ex_sorting_Procdess"><br>`[출처](https://cs186.fandom.com/wiki/External_Sorting)내부 정렬과 외부 정렬의 형태`<br><br>
...
- 오른쪽 리스트가 공백이 되면 종료.
<img src="/assets/images/INU/datastructure/Selection_sort.png" alt="Selection_sort_Procdess"><br>`선택 정렬(Selection Sort)`<br><br>
...
- 메모리 절약을 위해 **제자리 정렬(in-place sorting)방법**을 사용할 수 있다.
  ...
  <img src="/assets/images/INU/datastructure/in_place_sort.png" alt="in_place_sort_Procdess"   /><br>`제자리 정렬(in-place Sort)의 과정`<br><br>
...
<img src="/assets/images/INU/datastructure/Selection_sort_rs.png" alt="Selection_sort_rs_Procdess" /><br>`선택 정렬 알고리즘 실행 결과`<br><br>
...
<img src="/assets/images/INU/datastructure/Pick_card.png" alt="Pick_card_Procdess" /><br>`카드를 잘 정렬해 두었다가 뽑아야 한다`<br><br>
...
<img src="/assets/images/INU/datastructure/Insertion_sort.png" alt="Insertion_sort_Procdess" /><br>`삽입 정렬의 과정`<br>
...
> <img src="/assets/images/INU/datastructure/Insertion_sort_process.png" alt="Insertion_sort_process_Procdess" /><br>`삽입 정렬의 과정`<br>
...
<img src="/assets/images/INU/datastructure/Insertion_sort_rs.png" alt="Insertion_sort_rs_Procdess" /><br>`삽입 정렬 알고리즘 - 실행 결과`<br><br>
...
<img src="/assets/images/INU/datastructure/BubbleSort.png" alt="BubbleSort_Procdess"><br>`버블 정렬의 형태`<br><br>
...
<img src="/assets/images/INU/datastructure/BubbleSort2.png" alt="BubbleSort2_Procdess"><br>`버블 정렬의 과정`
...
1. 가장 바깥쪽의 루프는 리스트의 길이만큼 실행. (scan의 횟수) 또한 index가 내림차순으로 진행되며 내부 for문의 j의 인덱싱에 영향. 
2. j가 i보다 1작은 위치까지만 비교 및 교환을 실행하게 됨. -> 한번의 스캔 후 가장 오른쪽의 정렬된 요소는 배제
3. 내부 루프는 각 스캔마다 반복 횟수가 1씩 줄어들며 비교 및 교환 실행.
4. 위의 스캔 과정이 n-1번 반복되면 정렬이 끝나게 됨.
...
<img src="/assets/images/INU/datastructure/BubbleSort_bigO.png" alt="BubbleSort_bigO_Procdess"   /><br>`버블 정렬 알고리즘 - 복잡도 분석`
- 이동 횟수 :
