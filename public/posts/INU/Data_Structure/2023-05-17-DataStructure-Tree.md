...
<img src="/assets/images/INU/datastructure/tree-in-data-structure.png" alt="tree-in-data-structure_Procdess" /><br>
<img src="/assets/images/INU/datastructure/treeandelse.png" alt="treeandelse_Procdess" />[출처](https://www.scaler.com/topics/data-structures/tree-data-structure)`자료 구조의 트리. 나무를 거꾸로 엎어놓은 것 같은 모습을 하고 있다.`
...
<img src="/assets/images/INU/datastructure/treeWords.png" alt="treeWords_Procdess" />`트리(Tree)의 모습.`<br><br>
...
<img src="/assets/images/INU/datastructure/Btreevalidation.png" alt="Btreevalidation_Procdess">`이진 트리의 검증` <br><br>
- 이진 트리 :
...
<img src="/assets/images/INU/datastructure/btreelogic.png" alt="btreelogic_Procdess">`이진 트리의 성질 1`<br>
...
<img src="/assets/images/INU/datastructure/btreelogic2.png" alt="btreelogic2_Procdess">`이진 트리의 성질 2`<br>
...
<img src="/assets/images/INU/datastructure/maxnodecal.png" alt="maxnodecal_Procdess" />`이진 트리의 최대 노드 개수 (전체)`

<br><br>

<img src="/assets/images/INU/datastructure/btreelogic3.png" alt="btreelogic3_Procdess">`이진 트리의 성질 3` <br>
...
### 2-2. 이진 트리의 분류
<img src="/assets/images/INU/datastructure/kindofbtree.png" alt="kindofbtree_Procdess">`이진 트리의 분류` <br>

#### 2-2-1. 포화 이진 트리 (full binary tree)
<img src="/assets/images/INU/datastructure/maxbtree.png" alt="maxbtree_Procdess">`포화 이진 트리`<br>
<img src="/assets/images/INU/datastructure/maxbtreecal.png" alt="maxbtreecal_Procdess" />`포화 이진 트리에서의 전체 노드 개수 = 2^(1-1) + 2^(2-1) + 2^(3-1) + 2^(4-1) = 2^4 - 1 = 15` <br>
- 말 그대로 이진 트리의 각 레벨 마다의 최대 노드 만큼 꽉 채워져 있는 이진트리이다.
  - 높이가 k인 포화 이진트리는 정확히 2^k - 1 개의 노드를 가진다.
  - 일반적으로 포화이진트리의 노드 개수는 위와 같이 계산된다.
  - 포화 이진 트리는 위 사진과 같이 번호를 붙일 수 있으며, 레벨 단위로 왼쪽에서 오른쪽으로 부여한다.
    - 포화 이진 트리에서의 번호는 항상 일정하다. 
    - 루트 노드의 오른쪽 자식 번호는 항상 '3'이다.  

#### 2-2-2. 완전 이진 트리 (full binary tree)
<img src="/assets/images/INU/datastructure/completebtree.png" alt="completebtree_Procdess">`완전 이진 트리의 모습` <br>
...
<img src="/assets/images/INU/datastructure/btreewitharr.png" alt="btreewitharr_Procdess">`이진 트리의 배열 표현법` <br>
...
<img src="/assets/images/INU/datastructure/btreewithlink.png" alt="btreewithlink_Procdess">`이진 트리 - 링크 표현법` <br>
...
<img src="/assets/images/INU/datastructure/basicBtree.png" alt="basicBtree_Procdess" /><br>`실행 결과` <br>
- 왼쪽 부터 최상단 루트 노드이다.
  - 노드 n1 = 10
  - 노드 n2 = 20
  - 노드 n3 = 30
- 위와 같이 트리가 잘 구성된 것을 볼 수 있다.

<br><br>

**`아래는 이진 탐색 트리를 시각화 시켜주는 함수`**
...
#### 2-4-1. 이진 트리의 순회 방법 3가지

```
이진 트리를 순회하는 표준 방법에는 전위, 중위, 후위 세 가지 방법이 있다.

세가지 방법은 루트 노드와 좌, 우 자식 노드중 "어떤 노드를 먼저 방문하는 지" 에 따라 구분된 것이다.
루트 방문을 V, 왼쪽 서브 트리 방문을 L, 오른쪽 서브 트리 방문을 R 이라 하자. (일반적으로 왼쪽 서브트리 -> 오른쪽 서브트리 순으로 방문한다)

1. 전위 순회(preorder traversal) 
- VLR: 루트(V) -> 왼쪽 서브 트리(L) -> 오른쪽 서브 트리(R)

2. 중위 순회(inorder traversal) 
- LVR: 왼쪽 서브 트리(L) -> 루트(V) -> 오른쪽 서브 트리(R)

3. 후위 순회(postorder traversal) 
- LRV: 왼쪽 서브 트리(L) -> 오른쪽 서브 트리(R) -> 루트(V)
```

<img src="/assets/images/INU/datastructure/Btreetraversal.png" alt="Btreetraversal_Procdess">`이진 트리의 순회 방법`<br>
...
<img src="/assets/images/INU/datastructure/preorder.png" alt="preorder_Procdess">`이진 트리의 전위 순회` <br>
...
<img src="/assets/images/INU/datastructure/preorderusage.png" alt="preorderusage_Procdess">`전위 순회는 구조화된 문서와 같은 자료를 관리하는 것에 유용하게 사용된다.` <br>
...
<img src="/assets/images/INU/datastructure/inorder.png" alt="inorder_Procdess">`이진 트리의 중위 순회` <br>
- 중위 순회도 전위 순회와 같은 방식의 알고리즘이나, 순서만 다르다.

<br><br>

<img src="/assets/images/INU/datastructure/inorderusage.png" alt="inorderusage_Procdess">`중위 순회는 수식과 같은 자료를 관리하는 것에 유용하게 사용된다.`
...
<img src="/assets/images/INU/datastructure/postorder.png" alt="postorder_Procdess">`이진 트리의 후위 순회` <br>
...
<img src="/assets/images/INU/datastructure/postorderusage.png" alt="postorderusage_Procdess">`후위 순회는 디렉터리의 용량 계산과 같은 알고리즘에 유용하게 사용된다.`
...
<img src="/assets/images/INU/datastructure/prepostinorder.png" alt="prepostinorder_Procdess" />`실행 결과`
...
<img src="/assets/images/INU/datastructure/leveltraversal.png" alt="leveltraversal_Procdess">`큐(queue)를 사용하는 레벨 순회의 모습`<br>
...
<img src="/assets/images/INU/datastructure/leveltraversaltest.png" alt="leveltraversaltest_Procdess">`레벨 순회 실행 결과`<br>
...
1. 자식노드를 처리한 후에 부모노드를 처리 -> 후위 순회 (디렉토리의 용량 계산 - 하위 디렉토리의 용량부터 계산하며 올라와 전체 용량을 계산)
2. 부모노드를 처리한 후에 자식노드를 처리 -> 전위 순회 (구조화 된 문서의 출력 - 제목 -> 목차 -> 챕터 -> 내용)
3. 자식노드의 처리 중간에 부모노드의 처리가 필요한 경우 -> 중위 순회 (수식 트리 - 두 피연산자 사이에 연산자 필요 전위, 중위, 후위 모두 가능)
```
...
<img src="/assets/images/INU/datastructure/expressiontree.png" alt="expressiontree_Procdess">`이진 트리를 활용한 수식 트리 - a + b 를 수식 트리로 표현한 것`<br>
- 위와 같은 수식 트리를 앞에서 배운 전위, 중위, 후위 순회를 사용하여 읽게 되면 각각 전위, 중위, 후위 표기 수식이 된다.

<br><br>

<img src="/assets/images/INU/datastructure/btreenumcal.png" alt="btreenumcal_Procdess">`어떤 순회 방법을 사용하냐에 따라 이진 수식 트리의 표기법을 바꿀 수 있다.`<br>
...
<img src="/assets/images/INU/datastructure/btreecalsequence.png" alt="btreecalsequence_Procdess" />`수식 트리의 계산 순서`
...
<img src="/assets/images/INU/datastructure/Evaluate_Btree.png" alt="Evaluate_Btree_Procdess" />`수식 트리 계산 프로그램 실행 결과`

<br><br>

# 트리의 응용 (2) : 디렉토리 용량 계산 - 후위 순회

<img src="/assets/images/INU/datastructure/directoryCalEX.png" alt="directoryCalEX_Procdess">`이진 트리의 후위 순회를 이용하여 디렉토리 용량 계산하기`<br>
- `트리의 응용 : 디렉토리 용량 계산`
...
<img src="/assets/images/INU/datastructure/BTreeForDirc.png" alt="BTreeForDirc_Procdess">`디렉토리 용량 계산 결과`<br>
...
<img src="/assets/images/INU/datastructure/BTree_find_node.png" alt="BTree_find_node_Procdess" />`노드의 개수 구하기`<br>
...
<img src="/assets/images/INU/datastructure/Btree_find_subtree_max_height.png" alt="Btree_find_subtree_max_height_Procdess" />`전체 트리의 높이 구하기(이진 트리)`<br>
...
<img src="/assets/images/INU/datastructure/ThreadBTree.png" alt="ThreadBTree_Procdess" />`스레드 이진트리의 모습`<br>
