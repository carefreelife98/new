...
"컴퓨터과학에서 <span style="color:red">`데이터를 구조적으로 표현하는 방식`</span과 <span style="color:red">`이를 구현하는 데 필요한 알고리즘`</span>"<br>
- 컴퓨터의 메모리는 1차원 구조<a href="https://carefreelife98.github.io/inu/data_structure/%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0/DataStructure/#task-lists" class="btn">[1]</a이기 때문에 현실 세계의 다차원 데이터를 다루기 위해서는 이것을 1차원인 선 형태로 바꾸는 것이 필요하다.<br>
...
용어 그대로 <span style="color:green">`"자료(Data)의 종류"`</span이다. 한번쯤 코딩을 해보았다면 알 수 있을 것이다.<br>
