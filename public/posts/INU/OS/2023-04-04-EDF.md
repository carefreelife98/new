...
## EDF_Comparator 코드
<img src="/assets/images/INU/EDF_Comp.png" alt="EDF_Comp_Procdess">
...
<img src="/assets/images/INU/EDF_EX.png" alt="EDF_EX_Procdess"><br>
...
```
<img src="/assets/images/INU/AfterEDF.png" alt="AfterEDF_Procdess"><br> 
```
- FF: (RM|EDF) == (실패|실패)
- FT: (RM|EDF) == (실패|성공)
- TF: (RM|EDF) == (성공|실패)
