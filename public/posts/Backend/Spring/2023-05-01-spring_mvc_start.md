...
tags:
  - Spring
  - Java
thumbnail: "/assets/images/Spring/SpringMVC/rest_controller_1.png"
---
...
> <img src="/assets/images/Spring/SpringMVC/rest_controller_1.png" alt="rest_controller_1_Procdess" /><br>`@Restcontroller 사용하여 메시지 바디에 삽입할 String을 반환하는 모습`<br><br>
> <img src="/assets/images/Spring/SpringMVC/rest_controller_2.png" alt="rest_controller_2_Procdess" /><br>`@Restcontroller에서 반환한 String이 HTTP Message Body에 그대로 삽입되어 있는 모습`<br>
