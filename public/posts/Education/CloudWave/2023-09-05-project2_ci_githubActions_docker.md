...
<img src="/assets/images/CloudWave/project/ci_gitact.png" alt="ci_gitact_Procdess2"><br>`Github Action 을 사용해서 Docker Image를 자동 Build 및 Docker Hub에 Push 하는 모습`<br>
...
<img src="/assets/images/CloudWave/project/argoCD.png" alt="argoCD_Procdess2"><br>`ArgoCD의 작동 모습`<br>
...
> ```
>
> <img src="/assets/images/CloudWave/project/argo1.png" alt="argo1_Procdess2"><br>
...
> ```
> 
> <img src="/assets/images/CloudWave/project/argo2.png" alt="argo2_Procdess2"><br>
...
> ```
> 
> <img src="/assets/images/CloudWave/project/argo3.png" alt="argo3_Procdess2"><br>
> - 위 비밀번호는 다음 Step 에서 사용되므로 복사해두자.

4. [ArgoCD CLI] ArgoCD 초기 비밀번호 변경
> a. ArgoCD Pod 에 직접 접근 후 Login
> <img src="/assets/images/CloudWave/project/argo4.png" alt="argo4_Procdess2"><br>
> 
> ```shell
...
> <img src="/assets/images/CloudWave/project/argo5.png" alt="argo5_Procdess2"><br>
> 
> ```shell
...
> > <img src="/assets/images/CloudWave/project/argo6.png" alt="argo6_Procdess2"><br>[출처: 쿠버네티스 공식 홈페이지](https://kubernetes.io/ko/)
> 
> ```yaml
...
> ```
> 
> <img src="/assets/images/CloudWave/project/adgo7.png" alt="adgo7_Procdess2"><br>
> 
> ```shell
> $ kubectl get ing -A
> ```
...
> <img src="/assets/images/CloudWave/project/argo8.png" alt="argo8_Procdess2"><br>
...
> ```
> 
> <img src="/assets/images/CloudWave/project/argo9.png" alt="argo9_Procdess2"><br>
> - 가장 아래의 type : ClusterIP 부분을 LoadBalancer 로 수정
> <br><br>
> <img src="/assets/images/CloudWave/project/argo10.png" alt="argo10_Procdess2"><br>
> 
> ```shell
...
9. ArgoCD 접속 성공
> <img src="/assets/images/CloudWave/project/argo11.png" alt="argo11_Procdess2"><br>
> <img src="/assets/images/CloudWave/project/argo12.png" alt="argo12_Procdess2"><br>
...
> <img src="/assets/images/CloudWave/project/argo_git.png" alt="argo_git_Procdess2"><br>
...
> <img src="/assets/images/CloudWave/project/cd1.png" alt="cd1_Procdess2"><br>
...
> ```
> 
> <img src="/assets/images/CloudWave/project/deploy1.png" alt="deploy1_Procdess2"><br>
...
> ```
> 
> <img src="/assets/images/CloudWave/project/deploy2.png" alt="deploy2_Procdess2"><br>
...
>    <img src="/assets/images/CloudWave/project/apiVersionErr.png" alt="apiVersionErr_Procdess2"><br>
>    - `aws cli2` 로 upgrade 후 성공. <br> 
>    - 이제 ArgoCD 가 두번째 WAS Cluster 도 관리하고 있다. <br> 

3. [ArgoCD] 두 개의 EKS Cluster (WEB/WAS) 에 Application 배포.
> 
> <img src="/assets/images/CloudWave/project/deploy3.png" alt="deploy3_Procdess2"><br>
...
> <br><br>
> 
> <img src="/assets/images/CloudWave/project/deploy4.png" alt="deploy4_Procdess2"><br>
...
> **배포 성공** <br>
> 
> <img src="/assets/images/CloudWave/project/deploy5.png" alt="deploy5_Procdess2"><br>

<br><br>

# CGV 프로젝트 전체 CI / CD 과정

<img src="/assets/images/CloudWave/project/cicd1.png" alt="cicd1_Procdess2"><br>
...
> 2. **Git push**
> <img src="/assets/images/CloudWave/project/ci1.png" alt="ci1_Procdess2"><br><br>
> 3. **Github Actions**
> <img src="/assets/images/CloudWave/project/ci2.png" alt="ci2_Procdess2"><br>**`Docker Build`**<br><br>
> <img src="/assets/images/CloudWave/project/ci3.png" alt="ci3_Procdess2"><br>**`Docker Push`**<br>
...
> <img src="/assets/images/CloudWave/project/finalcd1.png" alt="finalcd1_Procdess2"><br>
...
> <img src="/assets/images/CloudWave/project/finalcd2.png" alt="finalcd2_Procdess2"><br>
...
<img src="/assets/images/CloudWave/project/cicdresult.png" alt="cicdresult_Procdess2"><br>`CICD test -> Gooloom - CGV 로 Title이 변경되어 배포된 것을 볼 수 있다.`<br> 
