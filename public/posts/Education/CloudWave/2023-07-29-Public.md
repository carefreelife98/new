...
thumbnail: "/assets/images/CloudWave/Public/Cloud.png"
---
...
<img src="/assets/images/CloudWave/Public/Cloud.png" alt="Cloud_Procdess"><br>`Cloud 개요`<br>
...
<img src="/assets/images/CloudWave/Public/serviceModel.png" alt="serviceModel_Procdess"><br>`Cloud Service Models`<br>
...
<img src="/assets/images/CloudWave/Public/cloudCharater.png" alt="cloudCharater_Procdess"><br>`Cloud 특징`<br>
...
<img src="/assets/images/CloudWave/Public/Localzone.png" alt="Localzone_Procdess"><br>[출처: AWS](https://docs.aws.amazon.com/local-zones/latest/ug/available-local-zones.html)`AWS Region / Available Zone`<br>
...
<img src="/assets/images/CloudWave/Public/AZ.png" alt="AZ_Procdess"><br>`AWS Availability Zone`<br>
...
<img src="/assets/images/CloudWave/Public/AwsServices.png" alt="AwsServices_Procdess"><br>[출처: 나라의 IT 잡아먹기](https://waspro.tistory.com/457)`AWS Services`<br>

<br><br>

# [AWS] Services Structure

<img src="/assets/images/CloudWave/Public/awsLocating.png" alt="awsLocating_Procdess"><br>`AWS Global Service, Region Service, VPC Service 배치 영역`<br>
...
**ARN 부여 방식**
<img src="/assets/images/CloudWave/Public/arn.png" alt="arn_Procdess"><br>`Amazon Resource Name의 부여 방식`<br>

<br><br>

# [AWS] AWS Well-Architectured Framework

<img src="/assets/images/CloudWave/Public/wellArchi.png" alt="wellArchi_Procdess"><br>[출처 : AWS Doc](https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html)`AWS가 제시하는 모범 구축 사례`<br>
...
1. **DNS Service**
    <img src="/assets/images/CloudWave/Public/arc1.png" alt="arc1_Procdess"><br>`DNS Service`<br>
    - 소규모 고객 시스템인 경우 최소한의 리소스를 사용하여 구축
    - DNS와 같은 기본 편의 서비스 사용
2. **Service 규모 확장에 따른 DB 분리**
   <img src="/assets/images/CloudWave/Public/arc2.png" alt="arc2_Procdess"><br>`Service 규모 확장에 따른 DB 분리`<br>
...
3. **수직적 / 수평적 규모 확장 (Scale up/down & Scale in/out)**
   <img src="/assets/images/CloudWave/Public/arc3.png" alt="arc3_Procdess"><br>`수직적 / 수평적 규모 확장 (Scale up/down & Scale in/out)`<br>
...
4. **데이터베이스의 성능 향상을 위한 Cache 전략**
   <img src="/assets/images/CloudWave/Public/arc4.png" alt="arc4_Procdess"><br>`데이터베이스의 성능 향상을 위한 Cache 전략`<br>
    - MSA 구조에서 각 서비스 마다의 데이터베이스를 Redis를 통해 연동하여 사용
5. **[Cloud Front(CDN)] 애플리케이션 성능 향상을 위한 캐시 전략**
   <img src="/assets/images/CloudWave/Public/arc5.png" alt="arc5_Procdess"><br>`[Cloud Front] 애플리케이션 성능 향상을 위한 캐시 전략`<br>
    - Loadbalancer
    - S3에 존재하는 캐시 데이터를 사용하여 보다 신속한 서비스를 제공
      - 캐시데이터: 변하지 않는 정적인 데이터 (웹 사이트 이미지 등)
6. [AWS RDB] Stateless Web Layer 구성을 통한 확장성 확보
   <img src="/assets/images/CloudWave/Public/arc6.png" alt="arc6_Procdess"><br>`Stateless Web Layer 구성을 통한 확장성 확보`<br>
    - 세션 관리
...
7. [AWS Route53 / Disaster Recovery] 데이터 센터 이중화를 통한 가용성 & 접근성의 확장
   <img src="/assets/images/CloudWave/Public/arc7.png" alt="arc7_Procdess"><br>`[Disaster Recovery / POP] 데이터 센터 이중화를 통한 가용성, 접근성의 확장`<br>
...
8. 서비스 결합도(응집도)를 낮추기 위한 Message Queue 활용
   <img src="/assets/images/CloudWave/Public/arc8.png" alt="arc8_Procdess"><br>`서비스 결합도(응집도)를 낮추기 위한 Message Queue 활용`<br>
...
9. 로그 수집, 모니터링, 자동화 도구 도입
   <img src="/assets/images/CloudWave/Public/arc9.png" alt="arc9_Procdess"><br>`로그 수집, 모니터링, 자동화 도구 도입`<br>
...
<img src="/assets/images/CloudWave/Public/SDEproc.png" alt="SDEproc_Procdess"><br>`시스템 개발 환경의 분류 및 절차`<br>
...
<img src="/assets/images/CloudWave/Public/resourcenaming.png" alt="resourcenaming_Procdess"><br>`Resource Naming 방식 - Kebab`<br>
