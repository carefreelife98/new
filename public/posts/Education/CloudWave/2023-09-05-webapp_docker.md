...
<img src="/assets/images/CloudWave/project/simpleapp.png" alt="simpleapp_Procdess">`CI/CD 환경 구축을 위한 Test App 모습`<br>
...
> <img src="/assets/images/CloudWave/project/docker1.png" alt="docker1_Procdess"><br>

2. **그럼 좌측 프로젝트 → build → libs 에 .Jar Snapshot이 생긴다.**
> <img src="/assets/images/CloudWave/project/docker2.png" alt="docker2_Procdess"><br>
> <img src="/assets/images/CloudWave/project/docker3.png" alt="docker3_Procdess"><br>
> ```bash
> $ java -jar *.jar
> ```
...
> <img src="/assets/images/CloudWave/project/docker4.png" alt="docker4_Procdess"><br>
> ```dockerfile
...
> <img src="/assets/images/CloudWave/project/docker5.png" alt="docker5_Procdess"><br>
> <img src="/assets/images/CloudWave/project/docker6.png" alt="docker6_Procdess"><br>
> ```bash
...
> <br><br>
> <img src="/assets/images/CloudWave/project/docker7.png" alt="docker7_Procdess"><br>
> - 이미지 빌드가 성공했다면 후에 EKS에서 끌어다 사용 할 수 있게 Docker hub로 push 해보자.

5. **AWS EKS 에 Bastion을 통해 접속 후 WAS 클러스터에 yaml apply를 통한 pod 생성**
> <img src="/assets/images/CloudWave/project/docker8.png" alt="docker8_Procdess"><br>
> - AWS EKS 클러스터 중 두번째 Private Subnet에 존재하는 WAS 클러스터 (lastDance2)에 접근.
> <br><br>
> <img src="/assets/images/CloudWave/project/docker9.png" alt="docker9_Procdess"><br>
...
> <br><br>
> <img src="/assets/images/CloudWave/project/docker10.png" alt="docker10_Procdess"><br>
...
> ```
>
> <img src="/assets/images/CloudWave/project/mod1.png" alt="mod1_Procdess"><br>정상적으로 Httpd 컨테이너에 접속한 모습<br>
...
> <img src="/assets/images/CloudWave/project/httpdconf1.png" alt="httpdconf1_Procdess"><br><br>
> <img src="/assets/images/CloudWave/project/httpdconf2.png" alt="httpdconf2_Procdess"><br><br>
> <img src="/assets/images/CloudWave/project/httpdconf3.png" alt="httpdconf3_Procdess"><br><br>
...
> <img src="/assets/images/CloudWave/project/httpd-vhost.png" alt="httpd-vhost_Procdess"><br><br>
...
> <img src="/assets/images/CloudWave/project/dockerCommit.png" alt="dockerCommit_Procdess"><br><br>
> 
> ```shell
...
>
> <img src="/assets/images/CloudWave/project/modSuccess.png" alt="modSuccess_Procdess"><br>
> <img src="/assets/images/CloudWave/project/modSuccess2.png" alt="modSuccess_Procdess2"><br>`Apache2(httpd) 와 Spring boot 내장 Tomcat 연동 성공`<br>
