...
- **메소드 호출**
  ...
  - 변수 s는 정수 30을 전달 받는다
  <br><br>
  <img src="/assets/images/INU/java/methodcall.png" alt="methodcall_Procdess"><br>`메소드 호출 및 리턴 과정`
<br><br>
...
> <img src="/assets/images/INU/java/javaKeyword.png" alt="javaKeyword_Procdess"><br>`Java Keyword`
...
- **특징**
  ...
  <img src="/assets/images/INU/java/javaType.png" alt="javaType_Procdess"><br>`Java - Type`
...
- **변수 선언**    
  ...
  <br><br>
  <img src="/assets/images/INU/java/variable.png" alt="variable_Procdess"><br>`Java - 변수와 선언`
