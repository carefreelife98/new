...
- System.in을 사용할 때 문제점
  - 키 값을 바이트 데이터로 넘겨주므로 응용프로그램이 문자 정보로 변환해야 한다.
    <img src="/assets/images/INU/java/systemin.png" alt="systemin_Procdess" /><br>`System.in 사용시 문제점`
...
```
>
<img src="/assets/images/INU/java/scanner.png" alt="scanner_Procdess" /><br>`Scanner 동작 과정 - System.in 에게 키를 읽게 하고, 원하는 타입으로 변환하여 리턴`
...
> 
<img src="/assets/images/INU/java/scannerinput.png" alt="scannerinput_Procdess" /><br>`Scanner 이용한 키 입력`
