...
<img src="/assets/images/INU/python/typeswitch.png" alt="typeswitch_Procdess" />``
...
- if문을 사용할 때 여러 동작의 수행이 필요할 경우, 각 명령어 줄 (line)을 들여쓰기를 통해 작성해야 함
  - <img src="/assets/images/INU/python/indent.png" alt="indent_Procdess"><br>`들여쓰기`<br><br> 
...
- 미리 정의된 기호 및 연결선을 사용하여 프로그램의 논리적인 흐름을 그림으로 표현한 것.
  ...
  <img src="/assets/images/INU/python/flowchart.png" alt="flowchart_Procdess"><br>`순서도의 모습`<br><br> 
  <img src="/assets/images/INU/python/flowchartex.png" alt="flowchartex_Procdess"><br>`순서도의 작성 예시`
...
<div markdown="1">       
  ...
  <img src="/assets/images/INU/python/2_1_1.png" alt="2_1_1_Procdess"   /><br>`1. 소스 코드`<br><br>
  <img src="/assets/images/INU/python/2_1_1_rs.png" alt="2_1_1_rs_Procdess"   /><br>`1. 실행 결과`
...
<div markdown="1">       
  ...
  <img src="/assets/images/INU/python/2_1_2.png" alt="2_1_2_Procdess"   /><br>`2. 소스 코드 및 실행 결과`<br><br>
...
<div markdown="1">       
  ...
  <img src="/assets/images/INU/python/2_1_3.png" alt="2_1_3_Procdess" /><br>`3. 소스 코드 및 실행 결과`<br><br>
