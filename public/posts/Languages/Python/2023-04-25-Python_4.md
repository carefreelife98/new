...
><img src="/assets/images/INU/python/function.png" alt="function_Procdess"><br>`함수의 수학적 정의`[WIKI](https://ko.wikipedia.org/wiki/%ED%95%A8%EC%88%98)
- **<span style="color:blue">주어진 입력을 가지고 어떠한 "기능"을 수행하여 그 결과를 출력:</span>**<br><br>
    "기능" or "모듈(Module)" or "메소드(Method)"
><img src="/assets/images/INU/python/functionmc.png" alt="functionmc_Procdess"   /><br>`함수`[WIKI](https://ko.wikipedia.org/wiki/%ED%95%A8%EC%88%98)
...
- **라이브러리 붙박이 함수 (Built-in Function)**
  - Python에서 기본적으로 제공하는 함수
    <img src="/assets/images/INU/python/builtin.png" alt="builtin_Procdess" /><br>`Built-in Functions`[Python](https://docs.python.org/3/library/functions.html)<br><br>
...
<img src="/assets/images/INU/python/5_1_1.png" alt="5_1_1_Procdess" /><br>`소스 코드 및 실행 결과`<br><br>
...
<img src="/assets/images/INU/python/5_1_2.png" alt="5_1_2_Procdess" /><br>`소스 코드 및 실행 결과`<br><br>
...
<img src="/assets/images/INU/python/5_1_3.png" alt="5_1_3_Procdess" /><br>`소스 코드 및 실행 결과`<br><br>
...
<img src="/assets/images/INU/python/5_1_4.png" alt="5_1_4_Procdess" /><br>`소스 코드 및 실행 결과`<br><br>
...
<img src="/assets/images/INU/python/5_2_1.png" alt="5_2_1_Procdess" /><br>`소스 코드 및 실행 결과`<br><br>
...
<img src="/assets/images/INU/python/5_2_2.png" alt="5_2_2_Procdess" /><br>`소스 코드 및 실행 결과`<br><br>
