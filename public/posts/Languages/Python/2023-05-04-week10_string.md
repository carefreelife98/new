...
> <img src="/assets/images/INU/python/dictRs.png" alt="dictRs_Procdess" /><br>`실행 결과`
...
> <img src="/assets/images/INU/python/dictTest.png" alt="dictTest_Procdess"   /><br>`실행 결과`
...
> ```
> <br><br>
> <img src="/assets/images/INU/python/dictMethods.png" alt="dictMethods_Procdess"   /><br>`실행 결과`
...
- 동등 비교 연산자 (==) 으로 비교 가능.
  - ```python
    ...
    ```
> <img src="/assets/images/INU/python/Counter.png" alt="Counter_Procdess"><br>`실행 결과`
...
> <img src="/assets/images/INU/python/ASCII.png" alt="ASCII_Procdess"   /><br>`ASCII`
...
> <img src="/assets/images/INU/python/ascii_concat.png" alt="ascii_concat_Procdess" /><br>`실행 결과`
...
- sigma(n) : 1부터 n까지 모든 자연수의 합을 계산.
  - <img src="/assets/images/INU/python/sigma_recursion.png" alt="sigma_recursion_Procdess"   /><br>`Sigma 함수의 정의`<br><br>
  - sigma(5) = 15
  - sigma(0) = 0
  - sigma(-3) = 0
...
- 재귀로 구현된 표현
  ...
  - <img src="/assets/images/INU/python/recursion_struct.png" alt="recursion_struct_Procdess"   /><br>`재귀 함수의 필수 조건`<br><br>
...
> <img src="/assets/images/INU/python/how_recursion.png" alt="how_recursion_Procdess" /><br>`점화식으로 표현된 재귀 함수`
...
<img src="/assets/images/INU/python/10_1_1.png" alt="10_1_1_Procdess" /><br>`문자열 치환 프로그램 실행 결과`
  </div>
</details>
...
```
<img src="/assets/images/INU/python/10_1_2,3.png" alt="10_1_2,3_Procdess" /><br>`카이사르(Caesar) 암호화 프로그램 실행 결과`
</div>
</details>
...
<img src="/assets/images/INU/python/10_2_2_permutation_rs.png" alt="10_2_2_permutation_rs_Procdess"   /><br>`순열 출력 프로그램 실행 결과`
...
<img src="/assets/images/INU/python/10_2_1_V1_rs.png" alt="10_2_1_V1_rs_Procdess"   /><br>`V1 실행 결과`<br><br>
  </div>
  </details>
...
<img src="/assets/images/INU/python/10_2_1_V2_rs.png" alt="10_2_1_V2_rs_Procdess"   /><br>`V2 실행 결과`<br><br>
  </div>
  </details>
...
- <img src="/assets/images/INU/python/10_2_1_EX.png" alt="10_2_1_EX_Procdess"><br>`입출력 예시 화면`
