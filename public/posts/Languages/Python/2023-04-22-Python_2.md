...
>
- 수학과 거의 유사: 단항식 ➡️ 다항식
  <img src="/assets/images/INU/python/calpriority.jpg" alt="calpriority_Procdess"><br>`산술 연산자의 계산 우선 순위`<br><br>
- 괄호를 통해 우선순위 지정 가능
  ```python
  >>> -6 ** 2 
  -36
...
- 산술 연산자 > 할당 연산자
  ...
  ```
- 산술 연산은 할당 연산과 결합 가능
  - <img src="/assets/images/INU/python/calpriority2.png" alt="calpriority2_Procdess"><br>`산술 연산자, 할당 연산과의 결합`<br><br>
  - 산술 연산자 > 할당 연산자
  - 모든 산술 연산이 끝난 후, 할당 연산 수행
  ```python
  >>> a = 36
...
<img src="/assets/images/INU/python/Comment.png" alt="Comment_Procdess"><br>`주석문의 사용 예시`
...
<div markdown="1">
  ...
  <img src="/assets/images/INU/python/3_1_1.png" alt="3_1_1_Procdess"   /><br>`소스코드 및 결과`
...
<div markdown="1">
  ...
  <img src="/assets/images/INU/python/3_1_2.png" alt="3_1_2_Procdess"   /><br>`소스코드 및 결과`
...
<div markdown="1">
  ...
  <img src="/assets/images/INU/python/3_1_3.png" alt="3_1_3_Procdess"   /><br>`소스코드`
...
<div markdown="1">
  ...
  <img src="/assets/images/INU/python/3_1_3_rs.png" alt="3_1_3_rs_Procdess"   /><br>`실행 결과`
